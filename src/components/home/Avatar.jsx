...
import './Avatar.css';
  ...
  const theme = {
    ...
    imageDark: '#01131f',
    imageClothes: '#01131f'};
    // Добавить другие цвета в объекте theme
  return (
    <svg
      version="1.1"
    ...
    <g id="path12"  opacity="0.8" fill={theme.primaryColor}>
    <path d="M -92 250 A 50 50 0 1 0 -95 250 Z" 
     transform="translate(200, 140)"/>
      <path d="M -92 250 A 50 50 0 1 0 -95 250 Z" 
     transform="translate(260, 155)"/>
      <path d="M -92 250 A 35 35 0 1 0 -95 250 Z"
...
<g id="path12"  opacity="0.4" fill={theme.primaryColor}>
    <path d="M -92 250 A 100 5 0 1 0 -95 250 Z" 
          ...
          (<g id="sides">
            ...
            (<g id="g63">
              <path
                id="path61"
                d=
                "M164,114.4l0.1,0.1c0,0,6.8-27.6,6-36.6s-3.3-18.7-5.1-21.7c-1.8-3.1-10.7-5.6-12-2.8              c-1.3,2.8-6.1,9-6.1,9s12.5,12,13,14.8c0.4,2.1,0.5,15.3-0.1,24.2C159.4,106.2,160.9,110.9,164,114.4z"
                fill={theme.hairColor}
              />
            </g>
            )
          ...
          (<g id="g210">
            ...
            <g id="g208">
              <path
                ...
                fill={theme.laptopColor}
              />
            </g>)
          </g>),
      <g id="logobook" transform="translate(-115, 135) rotate(-90)">
      <path
        d="M -92 250
         A 15 15 0 1 0 -107 250
         Q -102 245 -94 248
         L -92 250
         Q -102 250 -92 250 
         Z"
